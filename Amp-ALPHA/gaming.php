...
<link rel="icon" 
      type="image/png" 
      href="img/fav.jpg">
<link href="css/gaming_css.css" rel="stylesheet" type="text/css" >
...
<!--NAVEND-->
  ...
  <source src="video/gaming_video.mp4" type="video/mp4" >
</video>
...
<div >
  <form action="addtocart.php" method="POST">
    <ul style="display:grid;grid-template-columns: repeat(auto-fit, minmax(200px, 5fr));grid-gap: 15px;">
      <li style="list-style-type:none; padding: 0px;font-size: 14px;padding: 20px;"><img id="img1" src="img/rtxmsi.png" width="700">
     </li>
      <li id="font1" style="list-style-type:none;background-color:#fff;border-radius: 3px; margin-top:-0px;padding-left: 20px; ">
        <h1 id="font2" >GEFORCE RTX:</h1> <br> <br> 
      <input name="qnt" type="number" placeholder="Quantity" autocomplete="off" min="1" max="5" value="1"> 
      <input name="p_name" value="GEFORCE RTX" type="hidden">
...
<!--KEYBOARD-->
  ...
  <form action="addtocart.php" method="POST">
    <ul style="display:grid;grid-template-columns: repeat(auto-fit, minmax(200px, 5fr));grid-gap: 15px;">
      <li id="font1" style="list-style-type:none;background-color:#fff;border-radius: 3px padding: 20px; "><h1 id="font2" >Aula Keyboard:</h1> <br> <br> 
      <input name="qnt" type="number" placeholder="Quantity" autocomplete="off" min="1" max="5" value="1"> 
      <input name="p_name" value="Aula Keyboard"  type="hidden">
      ...
      <li style="list-style-type:none; padding: 0px;font-size: 14px;padding: 20px;"><img id="img1" src="img/key.png" width="700">
     </li>
...
<div >
  <form action="addtocart.php" method="POST">
    <ul style="display:grid;grid-template-columns: repeat(auto-fit, minmax(200px, 5fr));grid-gap: 15px;">
      <li style="list-style-type:none; padding: 0px;font-size: 14px;padding: 20px;"><img id="img1" src="img/cabin.jpg" width="700">
     </li>
      <li id="font1" style="list-style-type:none;background-color:#fff;border-radius: 3px padding: 20px; "><h1 id="font2" >Predator Cabinet:</h1> <br> <br> 
      <input name="qnt" type="number" placeholder="Quantity" autocomplete="off" min="1" max="5" value="1">  
      <input name="p_name" value="Predator Cabinet" type="hidden">
